...
Gem::Specification.new do |s|
  s.name = %q{factorylabs-castronaut}
  s.version = "0.7.5"
  ...
  s.files = [
    "MIT-LICENSE",
     ...
     "lib/castronaut/application.rb",
     "lib/castronaut/application/application.rb",
     "lib/castronaut/application/public/javascripts/application.js",
     "lib/castronaut/application/public/javascripts/jquery.js",
     "lib/castronaut/application/public/stylesheets/screen.css",
     "lib/castronaut/application/views/layout.erb",
     "lib/castronaut/application/views/login.erb",
     "lib/castronaut/application/views/logout.erb",
     "lib/castronaut/application/views/proxy_validate.erb",
     "lib/castronaut/application/views/service_validate.erb",
